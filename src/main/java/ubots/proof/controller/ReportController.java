...
public class ReportController {
    ...
    @RequestMapping(value="/purchases/max" ,method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public List<Purchase> getPurchasesOrdenedTotal() {
        List<Purchase> ordenedPurchases = this.purchases;
        Collections.sort(ordenedPurchases, Collections.reverseOrder());
